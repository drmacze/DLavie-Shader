(() => {
  ...
  function polishProject(){
    ...
    const stats=$('.project-stats',page);if(stats){stats.childNodes.forEach(n=>{if(n.nodeType===3){n.textContent=n.textContent.replace(' downloads',' unduhan').replace(' stars',' bintang').replace('Updated ','Diperbarui ')}})}
