(() => {
  ...
  if(card&&!card.querySelector('.home-mc-brand')){
    ...
    const badge='<span class="home-mc-brand"><img src="assets/icon-minecraft-block.svg?v=67" alt=""><span>Minecraft Bedrock</span></span>';
  ...
  document.querySelectorAll('a[href*="github.com/drmacze/DLavie-Shader"]').forEach(a=>{
    if(!a.querySelector('img')){a.classList.add('home-github-link');a.insertAdjacentHTML('afterbegin','<img src="assets/icon-github.svg?v=67" alt="">')}
  });
})();
